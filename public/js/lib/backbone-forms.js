...
Form.editors.Radio = Form.editors.Select.extend({
  ...
  setValue: function(value) {
    ...
    this.$('input[type=radio][value="'+value+'"]').prop("checked", true);
    this.$('input[type=radio][value="'+value+'"]').parent().addClass('active');
  },
    ...
    <div class="btn-group" data-toggle="buttons">\
      <% _.each(items, function(item) { %>\
        <label class="btn btn-primary">\
            <input type="radio"id="<%= item.id %>" name="<%= item.name %>" value="<%= item.value %>"><%= item.label %>\
        </label>\
      <% }); %>\
    </div>\
    <!--<ul>\
